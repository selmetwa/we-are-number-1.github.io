...
function loadMap(valueFromClick) {
  ...
  d3.csv("data/country-data.csv", function(error, data) {
    ...
    const map = d3
      ...
      .append('svg')
      // Set the viewBox to encompass the full width and height you've calculated
      .attr('viewBox', `0 0 ${width} ${height}`)
      .attr('preserveAspectRatio', 'xMidYMid meet') // Adjust how the SVG scales
      .append('g')
      .attr('class', 'map')
...
africaKey.addEventListener('click', () => {
  ...
  continentKeys.africaKeyActive == true ? africaKey.style.backgroundColor = '#242D2F' : africaKey.style.backgroundColor = '#ffffff'
  getValue()
})
asiaKey.addEventListener('click', () => {
  ...
  continentKeys.asiaKeyActive == true ? asiaKey.style.backgroundColor = '#242D2F' : asiaKey.style.backgroundColor = '#ffffff'
  getValue()
})
europeKey.addEventListener('click', () => {
  ...
  continentKeys.europeKeyActive == true ? europeKey.style.backgroundColor = '#242D2F' : europeKey.style.backgroundColor = '#ffffff'
  getValue()
})
southAmericaKey.addEventListener('click', () => {
  ...
  continentKeys.southAmericaKeyActive == true ? southAmericaKey.style.backgroundColor = '#242D2F' : southAmericaKey.style.backgroundColor = '#ffffff'
  getValue()
})
northAmericaKey.addEventListener('click', () => {
  ...
  if (continentKeys.northAmericaKeyActive) {
    ...
    northAmericaKey.style.color = '#ffffff'
  } else {
    northAmericaKey.style.backgroundColor = '#ffffff'
    northAmericaKey.style.color = '#1D1E2C'
  }
  getValue()
})
...
function renderScatterplot(xValue, yValue) {
  ...
  // Dynamically calculate viewBox dimensions
  ...
  var scatterplot = d3.select(".scatterplot-svg-container").append('svg')
    .attr("viewBox", `0 0 ${viewBoxWidth} ${viewBoxHeight}`) // Use dynamic viewBox for responsiveness
    .attr("preserveAspectRatio", "xMidYMid meet") // Adjust this value to change how the SVG scales
    .append("g")
  ...
  d3.csv("data/country-data.csv", function(error, data) {
    ...
    console.log({ yValueSelect, xValueSelect })
    ...
    const scatterplotTip = d3.tip()
      ...
      .html(function(d) {
        ...
        <div class="scatterplot-tooltip">
            ...
            <span>${xValueSelect.value}: ${d.wages}</span>
            <span>${yValueSelect.value}: ${d.hours}</span>
        </div>
        `
      })
...
function getValue() {
  ...
  d3.csv("data/country-data.csv", function(error, data) {
    ...
    const africa = ['Egypt', 'Algeria', 'Angola', 'Benin', 'Botswana', 'Burkina Faso',
      'Burundi', 'Cameroon', 'Central African Republic', 'Chad', 'Comoros', 'Congo (Dem. Rep.)', 'Congo (Rep.)', "Cote d'Ivoire", 'Djibouti', 'Equatorial Guinea',
    ...
    if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    }

    // n=5 
    else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    }

    // quadruples ?
    else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'south-america' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
      ...
      dataToBePassed.forEach(datum => { datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    }

    // triples 
    else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.africaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'africa' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.northAmericaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'north-america' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'africa' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'asia' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.africaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.oceaniaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.africaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'africa' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.africaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.oceaniaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.asiaKeyActive && continentKeys.africaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'asia' || datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.asiaKeyActive && continentKeys.oceaniaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'asia' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'oceania' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    }

    // doubles
    else if (continentKeys.africaKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.africaKeyActive && continentKeys.europeKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'europe' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.africaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.africaKeyActive && continentKeys.northAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'north-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.africaKeyActive && continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' || datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.southAmericaKeyActive && continentKeys.europeKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'south-america' || datum.continent == 'europe' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.southAmericaKeyActive && continentKeys.northAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'south-america' || datum.continent == 'north-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.southAmericaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'south-america' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.southAmericaKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'south-america' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.europeKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'europe' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.oceaniaKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'oceania' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.oceaniaKeyActive && continentKeys.europeKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'oceania' || datum.continent == 'europe' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive && continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'oceania' || datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    }

    // singles 6
    else if (continentKeys.africaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'africa' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.asiaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'asia' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.europeKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'europe' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.southAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'south-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.northAmericaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'north-america' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (continentKeys.oceaniaKeyActive) {
      dataToBePassed.forEach(datum => { datum.continent == 'oceania' ? newData.push(datum) : '' });
      dataToBePassed = newData
    } else if (all) {
